...
| WAVESHARE-ESP32-S3-TOUCH-LCD-1.46 | Waveshare | [Board Configuration][waveshare-1-46] |
...
[waveshare-1-46]: https://devices.esphome.io/devices/waveshare-esp32-s3-touch-lcd-1-46/
